...
def main():
    ...
    #entity_tables = ["customer", "customersubsidiaryrelationship", "vendor","vendorsubsidiaryrelationship"] #dimension tables con registros
    #entity_tables = ["bom","item","inventorybalance"]
    #TransactionAccountingLine, "transactionshippingaddress" transactionline
    #entity_tables = ["transactionaccountingline","transactionshippingaddress","transactionline"]
    entity_tables = ["account"]
    transactions_tables = []
    #transactions_tables = [ "CustPymt", "CustInvc", "Opprtnty", "PurchOrd", "SalesOrd"] #fact tables con registros
    try:
        ...
        for table in tables_to_process:
            try:
                ...
                df_table = extract_table_data(table, creds["ACCOUNT_ID"], access_token, final_entity_tables)
